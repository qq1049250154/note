...
![传统BIO通信模型图](https://typoralim.oss-cn-beijing.aliyuncs.com/img/2.png)
...
![伪异步IO模型图](https://typoralim.oss-cn-beijing.aliyuncs.com/img/3.png)
...
![一个单线程中Selector维护3个Channel的示意图](https://typoralim.oss-cn-beijing.aliyuncs.com/img/Slector.png)
...
![image-20210320135404194](https://typoralim.oss-cn-beijing.aliyuncs.com/img/image-20210320135404194.png)
