...
![image-20210320135845597](https://typoralim.oss-cn-beijing.aliyuncs.com/img/image-20210320135845597.png)
...
![不要在 foreach 循环里进行元素的 remove/add 操作](https://typoralim.oss-cn-beijing.aliyuncs.com/img/foreach-remove:add.png)
