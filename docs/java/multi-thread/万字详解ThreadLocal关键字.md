...
![](https://typoralim.oss-cn-beijing.aliyuncs.com/img/1.png)
...
![](https://typoralim.oss-cn-beijing.aliyuncs.com/img/2.png)
...
![](https://typoralim.oss-cn-beijing.aliyuncs.com/img/3.png)
...
![](https://typoralim.oss-cn-beijing.aliyuncs.com/img/4.png)
...
![image.png](https://typoralim.oss-cn-beijing.aliyuncs.com/img/5.png)

如果我们的**强引用**不存在的话，那么 `key` 就会被回收，也就是会出现我们 `value` 没被回收，`key` 被回收，导致 `value` 永远存在，出现内存泄漏。

### `ThreadLocal.set()`方法源码详解

![](https://typoralim.oss-cn-beijing.aliyuncs.com/img/6.png)
...
![](https://typoralim.oss-cn-beijing.aliyuncs.com/img/8.png)
...
![](https://typoralim.oss-cn-beijing.aliyuncs.com/img/7.png)
...
![](https://typoralim.oss-cn-beijing.aliyuncs.com/img/9.png)

这里直接将数据放到该槽位即可。

**第二种情况：** 槽位数据不为空，`key`值与当前`ThreadLocal`通过`hash`计算获取的`key`值一致：

![](https://typoralim.oss-cn-beijing.aliyuncs.com/img/10.png)

这里直接更新该槽位的数据。

**第三种情况：** 槽位数据不为空，往后遍历过程中，在找到`Entry`为`null`的槽位之前，没有遇到`key`过期的`Entry`：

![](https://typoralim.oss-cn-beijing.aliyuncs.com/img/11.png)
...
![](https://typoralim.oss-cn-beijing.aliyuncs.com/img/12.png)
...
![](https://typoralim.oss-cn-beijing.aliyuncs.com/img/13.png)
...
![](https://typoralim.oss-cn-beijing.aliyuncs.com/img/14.png)
...
![image-20210320141841930](https://typoralim.oss-cn-beijing.aliyuncs.com/img/image-20210320141841930.png)


**向后遍历过程中，如果没有找到相同key值的Entry数据：**

![](https://typoralim.oss-cn-beijing.aliyuncs.com/img/15.png)
...
![](https://typoralim.oss-cn-beijing.aliyuncs.com/img/16.png)
...
![](https://typoralim.oss-cn-beijing.aliyuncs.com/img/17.png)
...
![](https://typoralim.oss-cn-beijing.aliyuncs.com/img/18.png)
...
![](https://typoralim.oss-cn-beijing.aliyuncs.com/img/19.png)
...
![](https://typoralim.oss-cn-beijing.aliyuncs.com/img/24.png)

接着看看具体的`resize()`方法，为了方便演示，我们以`oldTab.len=8`来举例：

![](https://typoralim.oss-cn-beijing.aliyuncs.com/img/25.png)
...
![](https://typoralim.oss-cn-beijing.aliyuncs.com/img/26.png)

**第二种情况：** `slot`位置中的`Entry.key`和要查找的`key`不一致：

![](https://typoralim.oss-cn-beijing.aliyuncs.com/img/27.png)
...
![](https://typoralim.oss-cn-beijing.aliyuncs.com/img/28.png)
...
![](https://typoralim.oss-cn-beijing.aliyuncs.com/img/29.png)
...
![](https://typoralim.oss-cn-beijing.aliyuncs.com/img/30.png)

图中的`requestId`即为我们各个系统链路关联的`traceId`，系统间互相调用，通过这个`requestId`即可找到对应链路，这里还有会有一些其他场景：

![](https://typoralim.oss-cn-beijing.aliyuncs.com/img/31.png)
