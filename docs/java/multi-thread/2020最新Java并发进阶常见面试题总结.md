...
![](https://typoralim.oss-cn-beijing.aliyuncs.com/img/synchronized%E5%85%B3%E9%94%AE%E5%AD%97.png)
...
![image-20210320142340555](https://typoralim.oss-cn-beijing.aliyuncs.com/img/image-20210320142340555.png)
...
![image-20210320142351890](https://typoralim.oss-cn-beijing.aliyuncs.com/img/image-20210320142351890.png)
...
![CPU Cache](https://typoralim.oss-cn-beijing.aliyuncs.com/img/303a300f-70dd-4ee1-9974-3f33affc6574.png)
...
![JMM(Java内存模型)](https://typoralim.oss-cn-beijing.aliyuncs.com/img/0ac7e663-7db8-4b95-8d8e-7d2b179f67e8.png)

要解决这个问题，就需要把变量声明为**`volatile`**，这就指示 JVM，这个变量是共享且不稳定的，每次使用它都到主存中进行读取。

所以，**`volatile` 关键字 除了防止 JVM 的指令重排 ，还有一个重要的作用就是保证变量的可见性。**

![volatile关键字的可见性](https://typoralim.oss-cn-beijing.aliyuncs.com/img/d49c5557-140b-4abf-adad-8aac3c9036cf.png)
...
![ThreadLocal数据结构](https://typoralim.oss-cn-beijing.aliyuncs.com/img/threadlocal%E6%95%B0%E6%8D%AE%E7%BB%93%E6%9E%84.png)

`ThreadLocalMap`是`ThreadLocal`的静态内部类。

![ThreadLocal内部类](https://typoralim.oss-cn-beijing.aliyuncs.com/img/ThreadLocal%E5%86%85%E9%83%A8%E7%B1%BB.png)
...
**方式一：通过构造方法实现**
![image-20210320142429418](https://typoralim.oss-cn-beijing.aliyuncs.com/img/image-20210320142429418.png)
...
![image-20210320142436699](https://typoralim.oss-cn-beijing.aliyuncs.com/img/image-20210320142436699.png)
...
![image-20210320142447884](https://typoralim.oss-cn-beijing.aliyuncs.com/img/image-20210320142447884.png)
...
![image-20210320142455270](https://typoralim.oss-cn-beijing.aliyuncs.com/img/image-20210320142455270.png)
...
![image-20210320142503123](https://typoralim.oss-cn-beijing.aliyuncs.com/img/image-20210320142503123.png)
...
![image-20210320142509186](https://typoralim.oss-cn-beijing.aliyuncs.com/img/image-20210320142509186.png)
