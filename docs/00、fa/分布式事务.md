...
![image-20200304201018438](https://typoralim.oss-cn-beijing.aliyuncs.com/img/20210205094655.png)
...
![image-20200304202639509](https://typoralim.oss-cn-beijing.aliyuncs.com/img/20210205094658.png)
...
![image-20200304204442839](https://typoralim.oss-cn-beijing.aliyuncs.com/img/20210205094702.png)
...
![image-20200304205842784](https://typoralim.oss-cn-beijing.aliyuncs.com/img/20210205094705.png) 
...
![image-20200304210120471](https://typoralim.oss-cn-beijing.aliyuncs.com/img/20210205094709.png) 
...
![image-20200304210414309](https://typoralim.oss-cn-beijing.aliyuncs.com/img/20210205094712.png) 

接下来，用户的读操作就会得到 v1。这就叫一致性。

![image-20200304210506575](https://typoralim.oss-cn-beijing.aliyuncs.com/img/20210205094714.png) 

问题是，用户有可能向 G2 发起读操作，由于 G2 的值没有发生变化，因此返回的是 v0。G1 和 G2 读操作的结果不一致，这就不满足一致性了。

![image-20200304210521364](https://typoralim.oss-cn-beijing.aliyuncs.com/img/20210205094718.png)

为了让 G2 也能变为 v1，就要在 G1 写操作的时候，让 G1 向 G2 发送一条消息，要求 G2 也改成 v1。

![image-20200304210540168](https://typoralim.oss-cn-beijing.aliyuncs.com/img/20210205094720.png) 

这样的话，用户向 G2 发起读操作，也能得到 v1。

![image-20200304210557117](https://typoralim.oss-cn-beijing.aliyuncs.com/img/20210205094722.png) 
...
![image-20200305141029973](https://typoralim.oss-cn-beijing.aliyuncs.com/img/20210205094730.png) 
...
![image-20200305141318326](https://typoralim.oss-cn-beijing.aliyuncs.com/img/20210205094732.png) 
...
- 单点故障问题
  ...
  ![image-20200305142812815](https://typoralim.oss-cn-beijing.aliyuncs.com/img/20210205094748.png) 
...
![image-20200305155521612](https://typoralim.oss-cn-beijing.aliyuncs.com/img/20210205095251.png) 
...
![image-20200305155830732](https://typoralim.oss-cn-beijing.aliyuncs.com/img/20210205095255.png)
...
![image-20200305181454125](https://typoralim.oss-cn-beijing.aliyuncs.com/img/20210205095258.png)
...
![image-20200305183431211](https://typoralim.oss-cn-beijing.aliyuncs.com/img/20210205095301.png) 
...
![image-20200305200131083](https://typoralim.oss-cn-beijing.aliyuncs.com/img/20210205095304.png)



一次消息发送的时序图：

![image-20200305205430863](https://typoralim.oss-cn-beijing.aliyuncs.com/img/20210205095307.png)
...
![image-20200305212340203](https://typoralim.oss-cn-beijing.aliyuncs.com/img/20210205095313.png)
...
![image-20200305213652558](https://typoralim.oss-cn-beijing.aliyuncs.com/img/20210205095317.png)
...
![image-20200305214649845](https://typoralim.oss-cn-beijing.aliyuncs.com/img/20210205095319.png)
...
![image-20200305225811888](https://typoralim.oss-cn-beijing.aliyuncs.com/img/20210205095322.png)
...
![Saga 模式](https://typoralim.oss-cn-beijing.aliyuncs.com/img/20210205095328.png) 
...
![Seata](https://typoralim.oss-cn-beijing.aliyuncs.com/img/20210205095331.png)

### 3.1.1. Seata 产品模块

如下图所示，Seata 中有三大模块，分别是 TM、RM 和 TC。 其中 TM 和 RM 是作为 Seata 的客户端与业务系统集成在一起，TC 作为 Seata 的服务端独立部署。

![image-20200305225811888](https://typoralim.oss-cn-beijing.aliyuncs.com/img/20210205095334.png)



### 3.1.2.Seata支持的事务模型

Seata 会有 4 种分布式事务解决方案，分别是 AT 模式、TCC 模式、Saga 模式和 XA 模式。![image-20200305230513415](https://typoralim.oss-cn-beijing.aliyuncs.com/img/20210205095337.png) 
...
![image-20200306164728739](https://typoralim.oss-cn-beijing.aliyuncs.com/img/20210205095339.png)
...
![image-20200306170419354](https://typoralim.oss-cn-beijing.aliyuncs.com/img/20210205095343.png) 

找到项目所在目录，选中并打开：

![image-20200306170520985](https://typoralim.oss-cn-beijing.aliyuncs.com/img/20210205095346.png) 

项目结构如下：

![image-20200306171827203](https://typoralim.oss-cn-beijing.aliyuncs.com/img/20210205095349.png) 
...
![image-20200306173439268](https://typoralim.oss-cn-beijing.aliyuncs.com/img/20210205095353.png) 

库存：

![image-20200306173511332](https://typoralim.oss-cn-beijing.aliyuncs.com/img/20210205095355.png) 
...
![image-20200306173343839](https://typoralim.oss-cn-beijing.aliyuncs.com/img/20210205095417.png) 

查看数据库数据：

余额：

![image-20200306173602942](https://typoralim.oss-cn-beijing.aliyuncs.com/img/20210205095422.png) 

库存：

![image-20200306173629491](https://typoralim.oss-cn-beijing.aliyuncs.com/img/20210205095424.png) 

订单：

![image-20200306173700813](https://typoralim.oss-cn-beijing.aliyuncs.com/img/20210205095426.png) 
...
![image-20200306173916953](https://typoralim.oss-cn-beijing.aliyuncs.com/img/20210205095428.png)

看下用户余额：

![image-20200306224048175](https://typoralim.oss-cn-beijing.aliyuncs.com/img/20210205095431.png) 

因为扣款失败，因此这里没有扣减

来看下库存数据：

![image-20200306174001901](https://typoralim.oss-cn-beijing.aliyuncs.com/img/20210205095434.png) 
...
![image-20200306174740064](https://typoralim.oss-cn-beijing.aliyuncs.com/img/20210205095438.png) 



然后解压即可，其目录结构如下：

![image-20200306174818712](https://typoralim.oss-cn-beijing.aliyuncs.com/img/20210205095440.png) 
...
![image-20200306201749660](https://typoralim.oss-cn-beijing.aliyuncs.com/img/20210205095446.png) 
...
![image-20200306173916953](https://typoralim.oss-cn-beijing.aliyuncs.com/img/20210205095454.png)

看下用户余额：

![image-20200306224048175](https://typoralim.oss-cn-beijing.aliyuncs.com/img/20210205095456.png) 

因为扣款失败，因此这里没有扣减

来看下库存数据：

![image-20200306174001901](https://typoralim.oss-cn-beijing.aliyuncs.com/img/20210205095458.png) 
