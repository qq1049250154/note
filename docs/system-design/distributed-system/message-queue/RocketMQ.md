...
![](https://typoralim.oss-cn-beijing.aliyuncs.com/img/20210320144631.jpeg)
...
![](https://typoralim.oss-cn-beijing.aliyuncs.com/img/20210320144634.jpeg)
...
![](https://typoralim.oss-cn-beijing.aliyuncs.com/img/20210320144637.jpeg)
...
![](https://typoralim.oss-cn-beijing.aliyuncs.com/img/20210320144640.jpeg)
...
![](https://typoralim.oss-cn-beijing.aliyuncs.com/img/20210320144642.jpeg)

那么第二步，我们又添加了一个发送邮件，我们就得重新去修改代码，如果我们又加一个需求：用户购买完还需要给他加积分，这个时候我们是不是又得改代码？

![](https://typoralim.oss-cn-beijing.aliyuncs.com/img/20210320144645.jpeg)

如果你觉得还行，那么我这个时候不要发邮件这个服务了呢，我是不是又得改代码，又得重启应用？

![](https://typoralim.oss-cn-beijing.aliyuncs.com/img/20210320144647.jpeg)
...
![](https://typoralim.oss-cn-beijing.aliyuncs.com/img/20210320144650.jpeg)
...
![](https://typoralim.oss-cn-beijing.aliyuncs.com/img/20210320144652.jpeg)
...
![](https://typoralim.oss-cn-beijing.aliyuncs.com/img/20210320144656.png)

别急，办法总是有的。

## RocketMQ是什么？

![](https://typoralim.oss-cn-beijing.aliyuncs.com/img/20210320144658.jpeg)
...
![](https://typoralim.oss-cn-beijing.aliyuncs.com/img/20210320144701.jpeg)
...
![](https://typoralim.oss-cn-beijing.aliyuncs.com/img/20210320144703.jpeg)
...
![](https://typoralim.oss-cn-beijing.aliyuncs.com/img/20210320144706.jpeg)
...
![](https://typoralim.oss-cn-beijing.aliyuncs.com/img/20210320144709.jpeg)

**每个消费组在每个队列上维护一个消费位置** ，为什么呢？

因为我们刚刚画的仅仅是一个消费者组，我们知道在发布订阅模式中一般会涉及到多个消费者组，而每个消费者组在每个队列中的消费位置都是不同的。如果此时有多个消费者组，那么消息被一个消费者组消费完之后是不会删除的(因为其它消费者组也需要呀)，它仅仅是为每个消费者组维护一个 **消费位移(offset)** ，每次消费者组消费完会返回一个成功的响应，然后队列再把维护的消费位移加一，这样就不会出现刚刚消费过的消息再一次被消费了。

![](https://typoralim.oss-cn-beijing.aliyuncs.com/img/20210320144711.jpeg)

可能你还有一个问题，**为什么一个主题中需要维护多个队列** ？

答案是 **提高并发能力** 。的确，每个主题中只存在一个队列也是可行的。你想一下，如果每个主题中只存在一个队列，这个队列中也维护着每个消费者组的消费位置，这样也可以做到 **发布订阅模式** 。如下图。

![](https://typoralim.oss-cn-beijing.aliyuncs.com/img/20210320144714.jpeg)
...
- `Broker`： 主要负责消息的存储、投递和查询以及服务高可用保证。说白了就是消息队列服务器嘛，生产者生产消息到 `Broker` ，消费者从 `Broker` 拉取消息并消费。
  ...
  **一个 `Topic` 分布在多个 `Broker`上，一个 `Broker` 可以配置多个 `Topic` ，它们是多对多的关系**。 
  ...
  ![](https://typoralim.oss-cn-beijing.aliyuncs.com/img/20210320144717.jpeg)
...
![](https://typoralim.oss-cn-beijing.aliyuncs.com/img/20210320144721.jpeg)
...
![](https://typoralim.oss-cn-beijing.aliyuncs.com/img/20210320144723.jpeg)
...
![](https://typoralim.oss-cn-beijing.aliyuncs.com/img/20210320144727.jpeg)
...
![](https://typoralim.oss-cn-beijing.aliyuncs.com/img/20210320144731.png)
...
![](https://typoralim.oss-cn-beijing.aliyuncs.com/img/20210320144734.jpeg)
...
![](https://typoralim.oss-cn-beijing.aliyuncs.com/img/20210320144737.jpeg)
...
![](https://typoralim.oss-cn-beijing.aliyuncs.com/img/20210320144741.jpeg)
...
![](https://typoralim.oss-cn-beijing.aliyuncs.com/img/20210320144745.png)
...
![](https://typoralim.oss-cn-beijing.aliyuncs.com/img/20210320144747.jpeg)
...
![](https://typoralim.oss-cn-beijing.aliyuncs.com/img/20210320144750.jpeg)
