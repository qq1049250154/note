...
## [this 关键字](https://snailclimb.gitee.io/javaguide/#/docs/java/basis/Java常见关键字总结?id=this-关键字)
...
## [super 关键字](https://snailclimb.gitee.io/javaguide/#/docs/java/basis/Java常见关键字总结?id=super-关键字)
...
## [参考](https://snailclimb.gitee.io/javaguide/#/docs/java/basis/Java常见关键字总结?id=参考)

- https://www.codejava.net/java-core/the-java-language/java-keywords
- https://blog.csdn.net/u013393958/article/details/79881037

# [static 关键字详解](https://snailclimb.gitee.io/javaguide/#/docs/java/basis/Java常见关键字总结?id=static-关键字详解)

## [static 关键字主要有以下四种使用场景](https://snailclimb.gitee.io/javaguide/#/docs/java/basis/Java常见关键字总结?id=static-关键字主要有以下四种使用场景)
...
### [修饰成员变量和成员方法(常用)](https://snailclimb.gitee.io/javaguide/#/docs/java/basis/Java常见关键字总结?id=修饰成员变量和成员方法常用)
...
### [静态代码块](https://snailclimb.gitee.io/javaguide/#/docs/java/basis/Java常见关键字总结?id=静态代码块)
...
![img](https://typoralim.oss-cn-beijing.aliyuncs.com/img/20210201200017.jpeg)

静态代码块对于定义在它之后的静态变量，可以赋值，但是不能访问.

### [静态内部类](https://snailclimb.gitee.io/javaguide/#/docs/java/basis/Java常见关键字总结?id=静态内部类)
...
### [静态导包](https://snailclimb.gitee.io/javaguide/#/docs/java/basis/Java常见关键字总结?id=静态导包)
...
## [补充内容](https://snailclimb.gitee.io/javaguide/#/docs/java/basis/Java常见关键字总结?id=补充内容)

### [静态方法与非静态方法](https://snailclimb.gitee.io/javaguide/#/docs/java/basis/Java常见关键字总结?id=静态方法与非静态方法)
...
```java
Foo bar = new Foo(1);
bar.method2();Copy to clipboardErrorCopied
```
...
### [`static{}`静态代码块与`{}`非静态代码块(构造代码块)](https://snailclimb.gitee.io/javaguide/#/docs/java/basis/Java常见关键字总结?id=static静态代码块与非静态代码块构造代码块)
...
### [参考](https://snailclimb.gitee.io/javaguide/#/docs/java/basis/Java常见关键字总结?id=参考-1)
