...
![img](https://typoralim.oss-cn-beijing.aliyuncs.com/img/20210201145026.jpg)
...
```java
public Process exec(String[] cmdarray, String[] envp, File dir)  throws IOException {  		return new ProcessBuilder(cmdarray)    
    .environment(envp)    
    .directory(dir)    
    .start();  
}
