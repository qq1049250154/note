...
1. 线程B也同样读取变量X的值，由于L2缓存已经有缓存X=1，所以直接从L2缓存读取，之后线程B把X修改为2，同时写回L2和主内存。这时候的X值入下图所示。
   ...
   ![image-20210206115817338](https://typoralim.oss-cn-beijing.aliyuncs.com/img/image-20210206115817338.png)
...
![image-20210206115837191](https://typoralim.oss-cn-beijing.aliyuncs.com/img/image-20210206115837191.png)
...
![image-20210206115853038](https://typoralim.oss-cn-beijing.aliyuncs.com/img/image-20210206115853038.png)
...
另外，读者群已经开通，讲真的，就算不说话，在群里也能学到不少东西呢。加我微信，备注*进群*，我拉你！