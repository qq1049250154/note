# [线性数据结构](https://snailclimb.gitee.io/javaguide/#/docs/dataStructures-algorithms/data-structure/线性数据结构?id=线性数据结构)
...
![循环队列-队满](https://typoralim.oss-cn-beijing.aliyuncs.com/img/20210201171056.png)
