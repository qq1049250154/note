...
![img](https://tva1.sinaimg.cn/large/0081Kckwgy1gl526zw968j30eq0fs3zu.jpg)
...
![img](https://tva1.sinaimg.cn/large/0081Kckwgy1gl5chl50hqj30rv0i4my5.jpg)
...
![img](https://tva1.sinaimg.cn/large/0081Kckwgy1gl5cw5ptvej30gk0bk0tt.jpg)

假设一个简单的循环依赖场景，A、B互相依赖。

![img](https://tva1.sinaimg.cn/large/0081Kckwgy1gl5dbjtkr1j30bv050mx2.jpg)

A对象的创建过程：

1. 创建对象A，实例化的时候把A对象工厂放入三级缓存

![img](https://tva1.sinaimg.cn/large/0081Kckwgy1gl5e2p0fl2j30mw0dbdge.jpg)

1. A注入属性时，发现依赖B，转而去实例化B
2. 同样创建对象B，注入属性时发现依赖A，一次从一级到三级缓存查询A，从三级缓存通过对象工厂拿到A，把A放入二级缓存，同时删除三级缓存中的A，此时，B已经实例化并且初始化完成，把B放入一级缓存。

![img](https://tva1.sinaimg.cn/large/0081Kckwgy1gl5e4yfxalj30mc0anmxv.jpg)

1. 接着继续创建A，顺利从一级缓存拿到实例化且初始化完成的B对象，A对象创建也完成，删除二级缓存中的A，同时把A放入一级缓存
2. 最后，一级缓存中保存着实例化、初始化都完成的A、B对象

![img](https://tva1.sinaimg.cn/large/0081Kckwgy1gl5e6y6ygsj30mc0andgg.jpg)
...
![img](https://tva1.sinaimg.cn/large/0081Kckwgy1gl5y2nezydj30m40390st.jpg)
...
![图片来源网络，如有侵权请联系我删除](https://tva1.sinaimg.cn/large/0081Kckwgy1gl5zknm83ij31yl0u0n4l.jpg)图片来源网络，如有侵权请联系我删除