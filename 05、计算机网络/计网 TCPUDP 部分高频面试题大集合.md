...
![img](https://typoralim.oss-cn-beijing.aliyuncs.com/img/v2-c01a6511abf81f867fd0e531bd51af2c_720w.jpg)

UDP 首部字段只有 8 个字节，包括源端口、目的端口、长度、检验和。12 字节的伪首部是为了计算检验和临时添加的。

![img](https://typoralim.oss-cn-beijing.aliyuncs.com/img/v2-3bd45a13afe868cae6225d75b85e9c36_720w.jpg)
...
![img](https://typoralim.oss-cn-beijing.aliyuncs.com/img/v2-0673bbc84fe4440aed9d1dadc67ae79b_720w.jpg)
...
**![img](https://typoralim.oss-cn-beijing.aliyuncs.com/img/v2-8bf6f231cdd87b2613554f54424e8201_720w.jpg)**
...
![img](https://typoralim.oss-cn-beijing.aliyuncs.com/img/v2-1f03c5a6c04279d9c318ef48348dc32d_720w.png)

第二种情况，接收端只收到一个数据包，但是这一个数据包中包含了发送端发送的两个数据包的信息，这种现象即为粘包。这种情况由于接收端不知道这两个数据包的界限，所以对于接收端来说很难处理。

![img](https://typoralim.oss-cn-beijing.aliyuncs.com/img/v2-e090a51ff37d6dfd1de747c70288222a_720w.png)

第三种情况，这种情况有两种表现形式，如下图。接收端收到了两个数据包，但是这两个数据包要么是不完整的，要么就是多出来一块，这种情况即发生了拆包和粘包。这两种情况如果不加特殊处理，对于接收端同样是不好处理的。



![img](https://typoralim.oss-cn-beijing.aliyuncs.com/img/v2-6163805a4cbd6be0581cca82cd5ac8f5_720w.png)
...
![img](https://typoralim.oss-cn-beijing.aliyuncs.com/img/v2-c55cbe9732b1a2bf9b13e63bb489a650_720w.png)

其中，0 ≤ a ＜ 1，RTTs 随着 a 的增加更容易受到 RTT 的影响。超时时间 RTO 应该略大于 RTTs，TCP 使用的超时时间计算如下：

![img](https://typoralim.oss-cn-beijing.aliyuncs.com/img/v2-7b92eb20e4b0fb7f0a471a06806239a8_720w.jpg)
...
![img](https://typoralim.oss-cn-beijing.aliyuncs.com/img/v2-b9535beef75cdd742cb5718f97029a6f_720w.jpg)
...
![img](https://typoralim.oss-cn-beijing.aliyuncs.com/img/v2-62529f3bda992dc7035dcb13ef0da8b7_720w.jpg)
...
![img](https://typoralim.oss-cn-beijing.aliyuncs.com/img/v2-a62edcee3fb47ed147e56bdc8001feec_720w.jpg)
...
![img](https://typoralim.oss-cn-beijing.aliyuncs.com/img/v2-1cc37f757263f3cd58e917059cedc7b5_720w.jpg)
...
[http://www.cnblogs.com/panchanggui/p/9518735.html](https://link.zhihu.com/?target=http%3A//www.cnblogs.com/panchanggui/p/9518735.html)

[http://www.cnblogs.com/qcrao-2018/p/10182185.html](https://link.zhihu.com/?target=http%3A//www.cnblogs.com/qcrao-2018/p/10182185.html)

[http://github.com/CyC2018/CS-Notes/blob/master/docs/notes/](https://link.zhihu.com/?target=http%3A//github.com/CyC2018/CS-Notes/blob/master/docs/notes/)